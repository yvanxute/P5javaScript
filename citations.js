...
const Citation = {
    ...
    dom: {
        ...
        nbCit: document.getElementById('nbCitation')
    },
    methods: {
        ...
        test: function() {
            var test = Citation.dom.nbCit.value;
            console.log('test : ', test)
        },
        generationCitaion: function(randomDebutCitation, randomMilieuCitation, randomFinCitation) {
